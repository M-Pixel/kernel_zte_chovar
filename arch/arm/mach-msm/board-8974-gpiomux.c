...
static struct gpiomux_setting unused = {
...
#if !defined(CONFIG_BCM_BT) //for P897S01 broadcom  bt_dm remove: gpio46 is used as bt_uart
...
static struct msm_gpiomux_config mdm_configs[] __initdata = {
	...
	/* MDM2AP_STATUS */
#if !defined(CONFIG_BCM_BT) //for P897S01 broadcom bt_dm remove :gpio46 is used for bt_uart
	{
		.gpio = 46,
		.settings = {
...
#if !defined(CONFIG_BCM_BT) // bt_dm remove : gpio85 is used as bt_reg_on
...
static struct gpiomux_setting out_l = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting out_h = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_HIGH,
...
#if defined(CONFIG_FB_MSM_MDSS_HDMI_MHL_SII8334)  || defined(CONFIG_MHL_Sii8334) || defined(CONFIG_MHL_SII8240)
...
#if defined(CONFIG_MHL_SII8240) 
static struct gpiomux_setting mhl_active_ldo_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_HIGH
};
static struct gpiomux_setting mhl_suspend_ldo_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config msm_mhl_configs[] __initdata = {
...
#endif
#if defined(CONFIG_FB_MSM_MDSS_HDMI_MHL_SII8334) || defined(CONFIG_MHL_Sii8334)
	{
		/* mhl-sii8334 intr */
		.gpio = 46,
		.settings = {
...
#elif defined(CONFIG_MHL_SII8240)
	{
		/* mhl-sii8334 intr */
		.gpio = 68,
		.settings = {
	...
	{
		.gpio	= 57,		/* mhl ldo control */
		.settings = {
			[GPIOMUX_ACTIVE]    = &mhl_active_ldo_cfg,
			[GPIOMUX_SUSPENDED] = &mhl_suspend_ldo_cfg,
		},
	},
#endif
};
...
#if defined(CONFIG_BCM_BT)  ////for P897S01 broadcom bt_dm remove :gpio45 46 47 48is used for bt_uart
...
#if defined(CONFIG_BCM_BT)
static struct gpiomux_setting gpiomux_4339_reset_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config msm_blsp2_uart8_configs[] __initdata = {
	...
	{
		.gpio	= 85,	/* BLSP2 UART7 RFR */
		.settings = {
			[GPIOMUX_ACTIVE]    = &gpiomux_4339_reset_cfg, 
			[GPIOMUX_SUSPENDED] = &gpiomux_4339_reset_cfg,
		},
	},
};
#endif
#if !defined(CONFIG_BCM_BT) //bt_dm remove: gpio45 46 is used as uartdm
...
#ifdef CONFIG_LCD_VDD_5V_USE_EXTERN_CHIP_CONTROLED_GPIO
...
static struct msm_gpiomux_config msm_epm_configs[] __initdata = {
...
#endif
	{
		.gpio      = 96,		/* EPM MARKER1 */
		.settings = {
#if !defined(CONFIG_BCM_BT) // for 897S01 boardcom fm
            [GPIOMUX_SUSPENDED] = &gpio_epm_marker_config,
#else
			[GPIOMUX_SUSPENDED] = &gpio_suspend_config[1], // weizhijun
#endif
		},
	},
};
...
#if defined(CONFIG_KS8851) || defined(CONFIG_KS8851_MODULE)
#if 0
//yichangming the gpios are used by lcd
	{
...
//jht 20130906 add for nxp nfc +++
#if defined(CONFIG_PN544_NFC)
static struct gpiomux_setting out_low_np_2ma = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_2MA,
       .pull = GPIOMUX_PULL_NONE,
       .dir = GPIOMUX_OUT_LOW,
};
static struct gpiomux_setting in_pd_2ma = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_2MA,
       .pull = GPIOMUX_PULL_DOWN,
       .dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config nxp_nfc_configs[] __initdata = {
	{
	...
	},
	{
		.gpio = 26, /* NFC_EXT_EN */
		.settings = {
			[GPIOMUX_ACTIVE]    = &out_low_np_2ma,
			[GPIOMUX_SUSPENDED] = &out_low_np_2ma,
		},
	},
	{
		.gpio = 27, /* NFC_FW_DL */
	...
	},
	{
		.gpio = 59, /* NFC_IRQ */
		.settings = {
			[GPIOMUX_ACTIVE]    = &in_pd_2ma,
			[GPIOMUX_SUSPENDED] = &in_pd_2ma,
		},
	},
};
#endif
...
#if 0 //bt_dm : remove for brcm use auxpcm interface not i2s for bt sco
#if defined(CONFIG_BCM_BT)//bt_dm remove for use Mi2S_secondary instead of sec_pcm
...
#ifdef CONFIG_BCMDHD
static struct gpiomux_setting wifi_sus_cfg = {
        .func = GPIOMUX_FUNC_GPIO,
        .drv = GPIOMUX_DRV_12MA,
        .pull = GPIOMUX_PULL_NONE,
        .dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting wifi_act_cfg = {
        .func = GPIOMUX_FUNC_GPIO,
        .drv = GPIOMUX_DRV_12MA,
        .pull = GPIOMUX_PULL_NONE,
        .dir = GPIOMUX_OUT_LOW,
...
static struct msm_gpiomux_config msm8974_wifi_configs[] __initdata = {
	{
		.gpio = 76,
		.settings = {
			[GPIOMUX_SUSPENDED] = &wifi_sus_cfg,
			[GPIOMUX_ACTIVE] = &wifi_act_cfg,
		},
	},
};
#endif
...
#endif
#if 0 //bt_dm: brcm lgh for debug mi2s_pri
...
#endif 
#if 0 //bt_dm : brcm use auxpcm interface not i2s for bt sco
#if defined(CONFIG_BCM_BT)//bt_dm remove for use Mi2S_secondary instead of sec_pcm
static struct msm_gpiomux_config msm_sec_mi2s_configs[] __initdata = {
	{
		.gpio = 79,
		.settings = {
			[GPIOMUX_SUSPENDED] = &mi2s_sus_cfg,
...
#ifdef CONFIG_SND_SOC_ES325
	{
		.gpio	= 28,		/* ES325_LDO_EN */
		.settings = {
			[GPIOMUX_ACTIVE]    = &out_h,
			[GPIOMUX_SUSPENDED] = &out_l,
		},
	},
	{
		.gpio	= 57,		/* ES325_RST */
...
static struct msm_gpiomux_config msm_lcd_config[] __initdata = {
	{
		.gpio	= 0,		/* LCD_LANE_SEL */
		.settings = {
			[GPIOMUX_SUSPENDED] = &unused,//ycm
		},
	},
		{
		.gpio	= 1,		/* LCD external lcd backlight en pin  ---reserve */
		.settings = {
			[GPIOMUX_SUSPENDED] = &unused,//ycm
#ifdef CONFIG_LCD_BACKLIGHT_USE_EXTERN_CHIP_CONTROLED_GPIO
			[GPIOMUX_SUSPENDED] = &lcd_bl_active,//ycm
#endif
			[GPIOMUX_ACTIVE] = &lcd_bl_active,//ycm
		},
	},
	{
		.gpio	= 2,		/* LCD_ID_0 */
		.settings = {
		[GPIOMUX_ACTIVE] = &lcd_id_activity,
			[GPIOMUX_SUSPENDED] = &lcd_id_suspend,//zhengchao
		},
	},
	{
		.gpio	= 3,		/* LCD_ID_1 */
...
static struct msm_gpiomux_config msm8974_sdc4_configs[] __initdata = {
	...
	},
	{
		...
		.gpio      = 96,
		.settings = {
#if !defined(CONFIG_BCM_BT) // for boardcom fm
            [GPIOMUX_ACTIVE]    = &sdc4_cmd_data_0_3_actv_cfg,
            [GPIOMUX_SUSPENDED] = &sdc4_suspend_cfg,
#else
			[GPIOMUX_ACTIVE]    = &gpio_suspend_config[1], // weizhijun
			[GPIOMUX_SUSPENDED] = &gpio_suspend_config[1], // weizhijun
#endif
		},
	},
...
//jht 20130906 add for nxp nfc +++
#if defined(CONFIG_PN544_NFC)
	msm_gpiomux_install(nxp_nfc_configs, ARRAY_SIZE(nxp_nfc_configs));
#endif
//jht 20130906 add for nxp nfc ---
	msm_gpiomux_install(msm_blsp2_uart7_configs,
			 ARRAY_SIZE(msm_blsp2_uart7_configs));
#if defined(CONFIG_BCM_BT) ////for P897S01 broadcom bt_dm remove :gpio45 46 is used for bt_uart
	msm_gpiomux_install(msm_blsp2_uart8_configs,
			 ARRAY_SIZE(msm_blsp2_uart8_configs));
#endif
//jht 20130922 add for BCM4339 sdcc3 +++
#ifndef CONFIG_BCMDHD
	msm_gpiomux_install(wcnss_5wire_interface,
				ARRAY_SIZE(wcnss_5wire_interface));
#else
	(void)wcnss_5wire_interface;
#ifdef CONFIG_BOARD_CHOVAR
...
//bt_dm add for bt sco

#if defined(CONFIG_BCM_BT)
	msm_gpiomux_install(msm8974_sec_auxpcm_configs,
				 ARRAY_SIZE(msm8974_sec_auxpcm_configs));
#endif
        if (of_board_is_liquid() || of_board_is_fluid() ||
						of_board_is_mtp())
		msm_gpiomux_install(msm_epm_configs,
				ARRAY_SIZE(msm_epm_configs));


#if 0 //bt_dm :  brcm lgh fordebug pri_mi2s
	msm_gpiomux_install(msm_pri_mi2s_configs,
			ARRAY_SIZE(msm_pri_mi2s_configs));
#endif 
#if 0 //bt_dm : now brcm use auxpcm interface for bt sco
#if defined(CONFIG_BCM_BT)//bt_dm remove for use Mi2S_secondary instead of sec_pcm
	msm_gpiomux_install(msm_sec_mi2s_configs,
			ARRAY_SIZE(msm_sec_mi2s_configs));
#endif		
#endif
...
//jht 20130830 add for BCM4339 +++
#ifdef CONFIG_BCMDHD
	msm_gpiomux_install(msm8974_wifi_configs,
			ARRAY_SIZE(msm8974_wifi_configs));
#endif
//jht 20130830 add for BCM4339 ---
#if !defined(CONFIG_BCM_BT) //bt_dm remove: gpio45 46 is used as bt_uart
	if (of_board_is_rumi())
	...
	msm_gpiomux_install(msm_lcd_config, ARRAY_SIZE(msm_lcd_config));	
