...
//add by 20140327_xumei,fix the opp RTS lost
void msm_cpu0_disable_pc(int enable)
{
	struct msm_pm_platform_data *mode;
	
	mode = &msm_pm_sleep_modes[MSM_PM_MODE(0, 3)];
	mode->idle_enabled = enable;
}
//add by 20140327_xumei,fix the opp RTS lost--end
