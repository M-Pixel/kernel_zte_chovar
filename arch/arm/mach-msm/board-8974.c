...
#include <linux/gpio.h>  //add by ZTE_BOOT
#include <linux/err.h>
...
static struct platform_device *zte_msm8974_common_devices[] = {
/*
 * Add RAM console support by ZTE_BOOT_JIA_20130121 jia.jia
*/
#ifdef CONFIG_ZTE_RAM_CONSOLE
...
/*ZTE_BOOT get hw version---->*/
#define GPIO_VERSION0 94
#define GPIO_VERSION1 95

typedef enum {
    HW_VER_01      = 0, /* GPIO95:0 GPIO94:0 */
    HW_VER_02      = 1, /* GPIO95:0 GPIO94:1 */
    HW_VER_03      = 2, /* GPIO95:1 GPIO94:0 */
    HW_VER_04      = 3, /* GPIO95:1 GPIO94:1 */
    HW_VER_INVALID = 4,
    HW_VER_MAX
} zte_hw_ver_type;

#if defined(CONFIG_BOARD_CHOVAR)
...
uint8_t read_zte_hw_ver_byte(void)
{
    ...
    int32_t val_gpio_ver0 = 0, val_gpio_ver1 = 0;
    int32_t rc = 0;
    ...
    hw_ver = (zte_hw_ver_type)((val_gpio_ver1 << 1) | val_gpio_ver0);
    hw_ver = hw_ver&0x03;
...
{
	platform_add_devices(zte_msm8974_common_devices,
				ARRAY_SIZE(zte_msm8974_common_devices));
};
...
static void msm_reserve_sdlog_memory(void)
{
    ...
    {
        pr_err("sdlog is enable, resever 16M buffer in 0x6000000 \n");
...
#if 1 /* Support for reading board ID by ZTE_BOOT*/
