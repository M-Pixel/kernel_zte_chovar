...
/*
 * Modified for camera sensor by ZTE_JIA_20131119 jia.jia
 */
#if 0
...
#elif defined(CONFIG_IMX132)
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "3.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk2_clk.c, "3.qcom,camera"),
...
/** ZTE_ADD lvrongguo for es325 clk 2013-05-24 begin */
       CLK_LOOKUP("xo",  cxo_d1.c,      "fe12f000.slim"), // orig:see slim@fe12f000 at msm8974.dtsi
       // chenjun:CLK_LOOKUP("xo",  cxo_d1.c,      "fc12f000.slim.cj"), // chenjun:test:OK
/** ZTE_ADD lvrongguo for es325 clk 2013-05-24 end */
#endif	
//
