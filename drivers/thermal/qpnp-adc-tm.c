			...
			struct qpnp_adc_amux_properties *chan_prop)
{
	...
	#if 0  //change delay time from 0 to 10ms.
...
#if 1 //lhx_pm_20130822 disable qpnp_adc_tm_low_interrupt temporary to avoid wakeup,which should solve in CR490033  //reset at 20140415
	if (rc) {
		dev_err(&spmi->dev, "failed to request adc irq\n");
		goto fail;
	} else {
