...
/*
 * Added by ZTE_JIA_20131204 jia.jia
 */
#if 1
	dprintk(VIDC_INFO, "type: %d, index: %d\n", f->type, f->index);
#endif
...
/*
 * Modified by ZTE_JIA_20131204 jia.jia
 *
 * 'VIDIOC_S_FMT' is call after 'VIDIOC_ENUM_FMT' if 'No more formats found',
 * therefore, set the level of 'dprintk' as 'VIDC_INFO' instead of 'VIDC_ERR'.
 */
#if 0
		dprintk(VIDC_ERR, "No more formats found\n");
#else
		dprintk(VIDC_INFO, "info: No more formats found\n");
#endif
